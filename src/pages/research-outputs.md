...
<p className="page-kicker">Publications and software</p>
...
- **Whole Blood Boundary Analysis of BioFET Based ctDNA Detection**  
  Accepted ACM NanoCom 2026 work on Debye screening, nonspecific adsorption, background fluctuations, and device noise.
- **Set Transformer Architectures and Synthetic Data Generation for Flow Guided Nanoscale Localization**  
  ACM NanoCom 2025 collaboration enabled by the project. [Open the ACM record](https://dl.acm.org/doi/abs/10.1145/3760544.3764129).
- **Work in Progress on Intra Body Nanonetworks for In Vivo Biomarker Detection in Capillaries**  
  ACM NanoCom 2024 output from early BeNiFIt modelling work. [Open the ACM record](https://dl.acm.org/doi/10.1145/3686015.3689424).
...
- **Related molecular communication and Internet of Bio Nano Things papers**  
  Broader collaborations that strengthened the project research profile.
...
- [BeNiFIt website repository](https://github.com/ethungshanshitiri/benifit)
